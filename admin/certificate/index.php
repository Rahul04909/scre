...
$sql = "SELECT s.id, s.enrollment_no, s.first_name, s.last_name, s.father_name, s.mobile, s.student_image, 
               s.enrollment_date, s.certificate_serial_no,
               c.course_name,
...
$countSql = str_replace("SELECT s.id, s.enrollment_no, s.first_name, s.last_name, s.father_name, s.mobile, s.student_image, 
               s.enrollment_date, s.certificate_serial_no,
               c.course_name,
               ctr.center_name, ctr.center_code", "SELECT COUNT(*)", $sql);
        ...
        <div id="page-content-wrapper" style="width: 100%; margin-left: 280px;">
            ...
            <div class="container-fluid px-4 py-5">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="fw-bold" style="color: #115E59;">Manage Certificates</h2>
                </div>
                                    ...
                                    <?php if (count($students) > 0): ?>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if (!empty($s['certificate_serial_no'])): ?>
                                                        <span class="badge bg-success"><?php echo htmlspecialchars($s['certificate_serial_no']); ?></span>
                                                    <?php else: ?>
                                                        <span class="badge bg-secondary">Not Generated</span>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="text-end pe-4">
                                                    <a href="generate-certificate.php?student_id=<?php echo $s['id']; ?>" class="btn btn-sm btn-primary" target="_blank">
                                                        <i class="fas fa-file-contract me-1"></i> Generate Certificate
                                                    </a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
