...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['save_category'])) {
    ...
    if ($id > 0) {
        // Update
        $stmt = $pdo->prepare("UPDATE blog_categories SET name = ?, slug = ?, status = ? WHERE id = ?");
        ...
        // Add
        $stmt = $pdo->prepare("INSERT INTO blog_categories (name, slug, status) VALUES (?, ?, ?)");
...
<head>
    <meta charset="UTF-8">
    <title>Manage Blog Categories - Admin</title>
        ...
        <div id="page-content-wrapper" style="margin-left: 280px;">
            <div class="container-fluid py-5 px-lg-5">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0 fw-bold">Manage Blog Categories</h2>
                </div>
                        ...
                        <div class="form-section">
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="cat_name" class="form-control" required placeholder="Ex: Tech News">
                                </div>
                                <div class="mb-3">
