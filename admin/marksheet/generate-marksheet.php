...
// 1. Fetch Student, Course, Center Info (Same as student/marksheet logic)
$sqlStudent = "
    SELECT s.*, 
...
if (empty($results)) {
    die("No results found for this marksheet (Unit: $unit_no).");
}
...
try {
    ...
    // Background - Adjust Path for Admin
    // Student path was: __DIR__ . '/background/marksheet.png'; (student/marksheet/background)
    // We are in admin/marksheet. 
    // We can reference the SAME background file using relative path to student folder.
    $bg_path = '../../student/marksheet/background/marksheet.png';
    ...
    // Generate QR Code (Robust API Strategy)
    ...
    <style>
        ...
        .container { padding: 40px 80px; padding-top: 220px; } 
                ...
                <tr>
                    <td width="40%" valign="top">
                        <table class="summary-table" width="100%">
                            ...
                            <tr><td>Exam Date</td><td>'.$issue_date.'</td></tr>
