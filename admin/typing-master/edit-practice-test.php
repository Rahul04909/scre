...
if (!isset($_GET['id'])) {
    header("Location: manage-practice-tests.php");
    exit;
}
...
if (isset($_POST['update_test'])) {
    ...
    try {
        $sql = "UPDATE typing_practice_tests SET 
                language_id = :lang_id, 
                test_title = :title, 
        ...
        header("Location: manage-practice-tests.php?msg=updated");
        exit;
    } catch (PDOException $e) {
...
<head>
    <meta charset="UTF-8">
    <title>Edit Practice Test - Admin</title>
        ...
        <div id="page-content-wrapper" style="margin-left: 280px;">
            <div class="container-fluid py-5 px-lg-5">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="mb-0">Edit Practice Test</h2>
                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="language_id" class="form-select" required>
                                        ...
                                        <?php foreach ($languages as $lang): ?>
                                            <option value="<?php echo $lang['id']; ?>" <?php echo ($lang['id'] == $test['language_id']) ? 'selected' : ''; ?>>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="test_title" class="form-control" value="<?php echo htmlspecialchars($test['test_title']); ?>" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Duration (Minutes) <span class="text-danger">*</span></label>
                                    <input type="number" name="duration_minutes" class="form-control" value="<?php echo $test['duration_minutes']; ?>" min="1" required>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Test Content <span class="text-danger">*</span></label>
                                <textarea id="summernote" name="test_content" required><?php echo $test['test_content']; ?></textarea>
                            </div>

                            <div class="d-flex justify-content-end">
                                <button type="submit" name="update_test" class="btn btn-primary btn-lg"><i class="fas fa-save me-2"></i> Update Test</button>
                            </div>
                        </form>
                    </div>
                </div>
