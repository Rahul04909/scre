...
if (isset($_POST['add_lesson'])) {
    ...
    try {
        $sql = "INSERT INTO typing_lessons (language_id, lesson_title, duration_minutes, lesson_content) 
        ...
        header("Location: manage-lessons.php?msg=added");
        exit;
    } catch (PDOException $e) {
...
<head>
    <meta charset="UTF-8">
    <title>Add New Lesson - Admin</title>
                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="lesson_title" class="form-control" placeholder="e.g. Home Row Practice" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Duration (Minutes) <span class="text-danger">*</span></label>
                                    <input type="number" name="duration_minutes" class="form-control" placeholder="e.g. 5" min="1" required>
                                </div>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Lesson Content <span class="text-danger">*</span></label>
                                <textarea id="summernote" name="lesson_content" required></textarea>
                            </div>

                            <div class="d-flex justify-content-end">
                                <button type="submit" name="add_lesson" class="btn btn-primary btn-lg"><i class="fas fa-save me-2"></i> Save Lesson</button>
                            </div>
                        </form>
                    </div>
                </div>
